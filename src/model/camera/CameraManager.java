...
import model.score.ScoreManager;public class CameraManager
{
	private float currentOffset;
	private float previousOffset;

	private final ScoreManager scoreManager;
	private final float scoreFactor;	public CameraManager(ScoreManager scoreManager, float scoreFactor)
	{
	...
	}	public void update(GameModel model, float deltaTime)
	{
		...
		float halfScreen = screenHeight / 2f;		float desiredOffset = 0;
